        ...
        {plans.map((plan) => (
          <Card key={plan.id} className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex shrink-0 items-center gap-2 self-end sm:self-center">
              ...
              <Link href={`/admin/child-guidance/${plan.id}`} className="flex items-center gap-1 rounded-lg bg-purple-50 px-3 py-2 text-sm font-medium text-purple-700 hover:bg-purple-100">
